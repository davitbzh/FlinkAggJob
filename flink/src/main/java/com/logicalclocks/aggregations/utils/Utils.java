...
import com.logicalclocks.aggregations.functions.MyAvroDeserializer;
...
public class Utils {
  ...
  public Properties getKafkaProperties() throws Exception {
    ...
    dataKafkaProps.setProperty("group.id",  "dummy_group_id");
  ...
  public DataStream<StoreEvent> getSourceKafkaStream(StreamExecutionEnvironment env,
                                                              String sourceTopic,
    ...
    FlinkKafkaConsumerBase<StoreEvent> kafkaSource = new FlinkKafkaConsumer<>(
        sourceTopic, new MyAvroDeserializer(), kafkaProperties)
        .setStartFromLatest()
